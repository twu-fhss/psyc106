...
\item
  Read \emph{Krause et al.~(2021). Revel for An Introduction to Psychological Science, 3rd Canadian Edition}\\
\item
  Review \href{PSYC106-CH9IntelligenceTesting-3rdEd.pptx}{\emph{Unit 2 - Slides}}
\end{itemize}
...
\item
  ...
  \tightlist
  \item
    Gr. \(\sigma\omicron\phi\omicron\sigma\) Sofos (Sophos) (Adjective) -- wise generally; shrewd, clever; learned, intelligent; in N.T. divinely instructed; furnished with Christian wisdom, spiritually enlightened
  \end{itemize}
\end{itemize}
